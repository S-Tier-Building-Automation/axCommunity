...
public class BTrendDynamicAnalyzer extends BComponent
{
	...
	public void setHistory(BOrd paramBOrd){set(history, paramBOrd, null);}
	...
	public void setDateRange(BAbsTimeRange paramBAbsTimeRange){set(dateRange, paramBAbsTimeRange, null);}
	...
	public void setTimeRange(BDynamicTimeRange paramBDynamicTimeRange){set(timeRange, paramBDynamicTimeRange, null);}
	
	public static final Property timeRangeDelta	= newProperty(10, false, null);
	public boolean getTimeRangeDelta(){return getBoolean(timeRangeDelta);}
	public void setTimeRangeDelta(boolean paramBoolean){setBoolean(timeRangeDelta, paramBoolean, null);}
	...
	public void setCount(BStatusNumeric paramBStatusNumeric){set(count, paramBStatusNumeric, null);}
	...
	public void setMin(BStatusNumeric paramBStatusNumeric){set(min, paramBStatusNumeric, null);}
	...
	public void setMax(BStatusNumeric paramBStatusNumeric){set(max, paramBStatusNumeric, null);}
	...
	public void setAverage(BStatusNumeric paramBStatusNumeric){set(average, paramBStatusNumeric, null);}
	...
	public void setSum(BStatusNumeric paramBStatusNumeric){set(sum, paramBStatusNumeric, null);}
	...
	public void doExecute()
	{
		...
		try (TableCursor localTableCursor = localBITable.cursor())
		{
