...
/**
 * A simple Numeric in/out whose input link is created dynamically from the
 ...
 * If the ord is invalid the link is deleted and {@code out} goes to 0.
...
extends BComponent
{
  ...
  public void atSteadyState() throws Exception
  {
	...
	public static final Logger logger = Logger.getLogger("axCommunity.DynamicLinkNumeric");
