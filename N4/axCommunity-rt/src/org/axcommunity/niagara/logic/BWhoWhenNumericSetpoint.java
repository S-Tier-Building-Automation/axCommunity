 ...
 * @creation	9 Dec 11
 */
public class BWhoWhenNumericSetpoint extends BComponent
{
	...
	public BFacets getSlotFacets(Slot slot)
	{
		try
		{
			...
			{
				if(getFacets()==null || getFacets().isEmpty())	{ return slot.getFacets();	}
	...
	public void SetValue(BDouble v){invoke(SetValue, null);}
	public void doSetValue(BDouble v, Context cxin)
	{
		...
		fireValue(BDouble.make(v.getDouble()));
	}
	...
	public static final Topic Value = newTopic(Flags.SUMMARY);
	public void fireValue(BDouble event){fire(Value, event, null);}
