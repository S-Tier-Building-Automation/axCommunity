...
public class BLatestNumber extends BComponent
{
	...
	public void changed(Property p, Context cx)
	{
		...
		if(isRunning())
		{
			double min	= (double) getInMinValue().getValue();
			
			double n1	= (double) getIn1().getValue();
			double n2	= (double) getIn2().getValue();
			double n3	= (double) getIn3().getValue();
			double n4	= (double) getIn4().getValue();
			double n5	= (double) getIn5().getValue();
			double n6	= (double) getIn6().getValue();
			double n7	= (double) getIn7().getValue();
			double n8	= (double) getIn8().getValue();
			double n9	= (double) getIn9().getValue();
			double n10	= (double) getIn10().getValue();
			double n11	= (double) getIn11().getValue();
			double n12	= (double) getIn12().getValue();
			double n13	= (double) getIn13().getValue();
			double n14	= (double) getIn14().getValue();
			double n15	= (double) getIn15().getValue();
			double n16	= (double) getIn16().getValue();
			double n17	= (double) getIn17().getValue();
			double n18	= (double) getIn18().getValue();
			double n19	= (double) getIn19().getValue();
			double n20	= (double) getIn20().getValue();
			double n21	= (double) getIn21().getValue();
			double n22	= (double) getIn22().getValue();
			double n23	= (double) getIn23().getValue();
			double n24	= (double) getIn24().getValue();
