...
/**
 * Divides the dividend by the divisor on transition of the trigger from false to true
 * @author Mike Arnott, Kors Engineering
 */
public class BTrDivide extends BComponent{
	        ...
	        if (property == trigger){
	        	if (getTrigger().getValue() && fire == false){
	        		...
	        		if (b != 0){
	        			...
	        			getTrigger().setStatus(BStatus.fault);
	        		}
	            	fire = true;
	        	}
	        	else {
    ...
    public static final Type TYPE = Sys.loadType(BTrDivide.class);
